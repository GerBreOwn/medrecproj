...
class DoctorAdmin(admin.ModelAdmin):
	pass
	list_display = ('first_name', 'last_name', 'suffix',  'telephone', 'lic_no', 'ptr_no','s2_no')#'off_hour',
	fields = [('first_name', 'ast_name', 'suffix'), ('telephone'), ('lic_no', 'ptr_no', 's2_no')] #'dr_off_hour',
